...
func TestSession(t *testing.T) {
	...
	go func() {
		...
		}).UseSession(Provider(redisOptions), &s.Config{Valid: time.Minute}, nil).Run()
	}()
...
func TestSessionGet(t *testing.T) {
	...
	go func() {
		...
		}).UseSession(Provider(redisOptions), &s.Config{Valid: time.Minute}, &s.Listener{Created: func(session s.Session) {
